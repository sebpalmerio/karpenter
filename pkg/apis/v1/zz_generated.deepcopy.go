...
func (in *NodeClaimStatus) DeepCopyInto(out *NodeClaimStatus) {
	*out = *in
	...
	if in.RepairAttempt != nil {
		in, out := &in.RepairAttempt, &out.RepairAttempt
		*out = new(RepairAttemptStatus)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RepairAttemptStatus) DeepCopyInto(out *RepairAttemptStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RepairAttemptStatus.
func (in *RepairAttemptStatus) DeepCopy() *RepairAttemptStatus {
	if in == nil {
		return nil
	}
	out := new(RepairAttemptStatus)
